        ...
        <div className="container mx-auto px-6 py-5 max-w-6xl">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-3">
              <Link
                href="/admin/menu"
                className="border border-neutral-200 rounded-lg bg-transparent px-3 py-1.5 text-sm font-medium hover:bg-neutral-50 transition-colors"
              >
                Menu
              </Link>
              <Link
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold bg-red-50 text-red-700 border border-red-200">
                {receivedOrders.length} pending
              </span>
            </div>
            <div className="space-y-3">
              {receivedOrders.length === 0 ? (
                ...
                receivedOrders.map((order) => (
                  <div
                    key={order.$id}
                    className="bg-white rounded-2xl p-5 border-2 border-[#86a349]"
                  >
        ...
        <div className="grid lg:grid-cols-2 gap-6 mt-6">
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold bg-green-50 text-green-700 border border-green-200">
                ...
                readyOrders.map((order) => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        onClick={() =>
                          handleStatusUpdate(order.$id!, "taken-unpaid")
                        }
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold bg-orange-50 text-orange-700 border border-orange-200">
                {takenOrders.length} unpaid
              </span>
            </div>
            <div className="space-y-3">
              {takenOrders.length === 0 ? (
                ...
                takenOrders.map((order) => (
                  <div
                    key={order.$id}
                    className="bg-white rounded-2xl p-5 border border-orange-200"
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        <div className="text-2xl font-bold text-neutral-900 mb-1">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-neutral-600 mb-3">
                When you mark an order as ready, the student receives:
              </p>
              <div className="bg-neutral-50 rounded-xl p-4 border border-neutral-200">
                <p className="text-sm text-neutral-900">
                  "Order #42 is ready! Please proceed to the counter for payment
                  and pickup."
                </p>
              </div>
            </div>
